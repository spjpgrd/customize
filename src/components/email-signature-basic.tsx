                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style={{ verticalAlign: "top", paddingLeft: "0px", paddingTop: "0px", paddingBottom: "0px", paddingRight: "0px" }}>
                                <p style={{ marginTop: "0px", textAlign: "left", color: "#555759", fontFamily: "'Effra','-apple-system', 'BlinkMacSystemFont','Segoe UI','Roboto','Helvetica','Arial','sans-serif','Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol','sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "normal", lineHeight: "1.5", paddingTop: "4px" }}><b style={{ fontWeight: "bold", color: "#26241F" }}><strong>Aware Columbus Office</strong></b><a style={{ textDecoration: "none", borderBottomWidth: "0", color: "#F16E25", fontFamily: "'Effra','-apple-system', 'BlinkMacSystemFont','Segoe UI','Roboto','Helvetica','Arial','sans-serif','Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol','sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "normal", lineHeight: "1.5" }} href="https://wrtp.me/HQ1directions">📍</a><br />111 Liberty Street • Suite 102 • Columbus, OH 43215<br /><span style={{ textAlign: "left", fontFamily: "'Effra','-apple-system', 'BlinkMacSystemFont','Segoe UI','Roboto','Helvetica','Arial','sans-serif','Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol','sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "normal", lineHeight: "1.5" }}><a style={{ textDecoration: "none", borderBottomWidth: "0", color: "#E64257", fontFamily: "'Effra', 'Lato', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica', 'Arial', 'sans-serif', 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "lighter", lineHeight: "1.5" }} href={"https://awarehq.com?utm_medium=" + this.props.utmParams.utmMedium + "?utm_source=" + this.props.utmParams.utmSource + "?utm_content=" + this.props.fullNameSlug + "-aware-brand-launch"}>Website</a> • <a style={{ textDecoration: "none", borderBottomWidth: "0", color: "#E64257", fontFamily: "'Effra','-apple-system', 'BlinkMacSystemFont','Segoe UI','Roboto','Helvetica','Arial','sans-serif','Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol','sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "lighter", lineHeight: "1.5" }} href={"http://awarehq.com/li?utm_medium=" + this.props.utmParams.utmMedium + "?utm_source=" + this.props.utmParams.utmSource + "?utm_content=" + this.props.fullNameSlug + "-aware-brand-launch"}>LinkedIn</a> • <a style={{ textDecoration: "none", borderBottomWidth: "0", color: "#E64257", fontFamily: "'Effra','-apple-system', 'BlinkMacSystemFont','Segoe UI','Roboto','Helvetica','Arial','sans-serif','Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol','sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "lighter", lineHeight: "1.5" }} href={"http://awarehq.com/tw?utm_medium=" + this.props.utmParams.utmMedium + "?utm_source=" + this.props.utmParams.utmSource + "?utm_content=" + this.props.fullNameSlug + "-aware-brand-launch"}>Twitter</a> • <a style={{ textDecoration: "none", borderBottomWidth: "0", color: "#E64257", fontFamily: "'Effra','-apple-system', 'BlinkMacSystemFont','Segoe UI','Roboto','Helvetica','Arial','sans-serif','Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol','sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "lighter", lineHeight: "1.5" }} href={"http://awarehq.com/fb?utm_medium=" + this.props.utmParams.utmMedium + "?utm_source=" + this.props.utmParams.utmSource + "?utm_content=" + this.props.fullNameSlug + "-aware-brand-launch"}>Facebook</a> • <a style={{ textDecoration: "none", borderBottomWidth: "0", color: "#E64257", fontFamily: "'Effra','-apple-system', 'BlinkMacSystemFont','Segoe UI','Roboto','Helvetica','Arial','sans-serif','Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol','sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "lighter", lineHeight: "1.5" }} href={"http://awarehq.com/ig?utm_medium=" + this.props.utmParams.utmMedium + "?utm_source=" + this.props.utmParams.utmSource + "?utm_content=" + this.props.fullNameSlug + "-aware-brand-launch"}>Instagram</a></span><br /><br /><span style={{ textAlign: "left", color: "#A4A1A1", fontFamily: "'Effra','-apple-system', 'BlinkMacSystemFont','Segoe UI','Roboto','Helvetica','Arial','sans-serif','Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol','sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "lighter", lineHeight: "1.5", paddingTop: "4px" }}>Formerly known as Wiretap</span></p>
                            </td >
                        </tr >
                    </tbody>
                </table>
