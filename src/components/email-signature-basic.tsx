                        ...
                        {!this.props.hideAwareLogo &&
                            <tr>
                                <td style={{ verticalAlign: "bottom", paddingLeft: "0px", paddingTop: "16px", paddingBottom: "0px", paddingRight: "0px", marginTop: "0px" }}>
                                    <a target="_blank" href={"https://awarehq.com?utm_medium=" + this.props.utmParams.utmMedium + "&utm_source=" + this.props.utmParams.utmSource + "&utm_content=" + this.props.fullNameSlug + "-aware-brand-launch"}><img src="/company-logos/aware-email-32.png" style={{ width: "128px", height: "32px", border: "0" }} width="128" height="32" alt="Aware Logo" title="Aware Logo" /></a>
                                </td>
                            </tr>
                        }
                        <tr>
                            <td style={{ verticalAlign: "top", paddingLeft: "0px", paddingTop: "0px", paddingBottom: "0px", paddingRight: "0px" }}>
                                <p style={{ marginTop: "0px", textAlign: "left", color: "#555759", fontFamily: "'Effra','-apple-system', 'BlinkMacSystemFont','Segoe UI','Roboto','Helvetica','Arial','sans-serif','Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol','sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "normal", lineHeight: "1.5", paddingTop: "4px" }}>
                                    ...
                                    {!this.props.hideSocialLinks &&
                                        <span style={{ textAlign: "left", fontFamily: "'Effra','-apple-system', 'BlinkMacSystemFont','Segoe UI','Roboto','Helvetica','Arial','sans-serif','Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol','sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "normal", lineHeight: "1.5" }}><a style={{ textDecoration: "none", borderBottomWidth: "0", color: "#E64257", fontFamily: "'Effra', 'Lato', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica', 'Arial', 'sans-serif', 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "normal", lineHeight: "1.5" }} target="_blank" href={"http://awarehq.com?utm_medium=" + this.props.utmParams.utmMedium + "&utm_source=" + this.props.utmParams.utmSource + "&utm_content=" + this.props.fullNameSlug + "-aware-brand-launch"}>Website</a> • <a style={{ textDecoration: "none", borderBottomWidth: "0", color: "#E64257", fontFamily: "'Effra','-apple-system', 'BlinkMacSystemFont','Segoe UI','Roboto','Helvetica','Arial','sans-serif','Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol','sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "normal", lineHeight: "1.5" }} target="_blank" href={"http://awarehq.com/li?utm_medium=" + this.props.utmParams.utmMedium + "&utm_source=" + this.props.utmParams.utmSource + "&utm_content=" + this.props.fullNameSlug + "-aware-brand-launch"}>LinkedIn</a> • <a style={{ textDecoration: "none", borderBottomWidth: "0", color: "#E64257", fontFamily: "'Effra','-apple-system', 'BlinkMacSystemFont','Segoe UI','Roboto','Helvetica','Arial','sans-serif','Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol','sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "normal", lineHeight: "1.5" }} target="_blank" href={"http://awarehq.com/tw?utm_medium=" + this.props.utmParams.utmMedium + "&utm_source=" + this.props.utmParams.utmSource + "&utm_content=" + this.props.fullNameSlug + "-aware-brand-launch"}>Twitter</a> • <a style={{ textDecoration: "none", borderBottomWidth: "0", color: "#E64257", fontFamily: "'Effra','-apple-system', 'BlinkMacSystemFont','Segoe UI','Roboto','Helvetica','Arial','sans-serif','Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol','sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "normal", lineHeight: "1.5" }} target="_blank" href={"http://awarehq.com/fb?utm_medium=" + this.props.utmParams.utmMedium + "&utm_source=" + this.props.utmParams.utmSource + "&utm_content=" + this.props.fullNameSlug + "-aware-brand-launch"}>Facebook</a> • <a style={{ textDecoration: "none", borderBottomWidth: "0", color: "#E64257", fontFamily: "'Effra','-apple-system', 'BlinkMacSystemFont','Segoe UI','Roboto','Helvetica','Arial','sans-serif','Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol','sans-serif'", fontSize: "10pt", fontStyle: "normal", fontWeight: "normal", lineHeight: "1.5" }} target="_blank" href={"http://awarehq.com/ig?utm_medium=" + this.props.utmParams.utmMedium + "&utm_source=" + this.props.utmParams.utmSource + "&utm_content=" + this.props.fullNameSlug + "-aware-brand-launch"}>Instagram</a><br /><br /></span>
                                    }
                                    {!this.props.hideFKAW &&
